	...
	<div class="modal-content">
		...
		<div id="notifications-container">
			<div class="notification-wrapper">
				<div class="res-empty notifs-empty">Loading Inbox...</div>
			</div>
		</div>
	</div>
</div>
...
<div id="search-menu" class="modal-bg">
	<div class="modal-content">
		...
		<div style="text-align: center">
			<div class="search-res-empty res-empty">Nothing to See Here</div>
...
<div id="top-bar">
	...
	<div style="float: left">
		<button id="open-search" onclick="openSearchMenu()">
			<div class="bullet-point">-&gt;</div> Search <div class="bullet-point">&lt;-</div>
		</button>
	</div>
